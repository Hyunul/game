...
export const EP2_PUZZLES: Puzzle[] = [
  ...
  { id: 'ep2-drawer',     room: 'sarangbang', era: 'present', requires: ['ep2-calendar'], answer: '0815', rewardItem: 'empty-envelope', consumes: ['news-clip'],
    hints: ['서랍 위 손글씨 "잊지 말자" — 무엇을?', '신문 기사와 달력이 가리키는 날짜, 0815.'] },
  { id: 'ep2-frame',      room: 'sarangbang', era: 'present', requires: ['ep2-drawer'], rewardItem: 'ev-letter', consumes: ['empty-envelope'],
    hints: ['과거와 현재, 액자의 모습이 다르다.', '기울어진 가훈 액자를 들춰보자.'] },
  { id: 'ep2-radio',      room: 'sarangbang', era: 'past',    requires: [], answer: '711', rewardItem: 'matches', consumes: ['news-clip'],
  ...
  { id: 'ep2-shed-door',  room: 'heotgan',    era: 'past',    requires: [], requiresItem: 'brass-key', consumes: ['brass-key'],
  ...
  { id: 'ep2-watch-lid',  room: 'heotgan',    requires: ['ep2-closet'], requiresItem: 'oil-bottle', rewardItem: 'ev-watch', consumes: ['oil-bottle'],
    hints: ['회중시계 뚜껑이 굳어 열리지 않는다.', '경첩에 기름을 쳐보자.'] },
  { id: 'ep2-lantern',    room: 'heotgan',    era: 'past',    requires: ['ep2-radio', 'ep2-shed-door'], requiresItem: 'oil-bottle', consumes: ['oil-bottle', 'matches'],
