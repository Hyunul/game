...
export const PUZZLES: Puzzle[] = [
  ...
  { id: 'home-phone', room: 'home', requires: ['home-calendar'], answer: '0508', consumes: ['memo-anniversary'],
    hints: ['전화를 걸 번호가 어딘가에 적혀 있을 텐데.', '기념일 메모의 날짜 0508을 다이얼로 돌려봐.'] },
  { id: 'home-tv', room: 'home', requires: ['home-phone'], answer: '7', consumes: ['photo'],
    hints: ['수화기 속 목소리가 TV를 켜보라고 했다.', '가족사진 뒷면의 채널 7을 맞춰봐.'] },
  { id: 'home-sewingbox', room: 'home', requires: [], requiresItem: 'backscratcher', rewardItem: 'sewingbox-key', consumes: ['backscratcher'],
    hints: ['장롱 위에 뭔가 있는데 손이 닿지 않아.', '긴 막대기 같은 것... 효자손을 써보자.'] },
  { id: 'home-final', room: 'home', requires: ['home-tv', 'home-sewingbox'], answer: '1987', requiresItem: 'sewingbox-key', consumes: ['sewingbox-key'],
    hints: ['자개장은 열쇠와 숫자 둘 다 필요해 보인다.', 'TV 화면에 떠 있던 숫자 1987을 입력해.'] },
  // 방 2 — 교실
  { id: 'class-timetable', room: 'class', requires: [],
    hints: ['칠판 옆 시간표가 이상하다.', '색칠된 칸: 수요일 3교시 — 좌표 (3,3)이다.'] },
  { id: 'class-locker', room: 'class', requires: ['class-timetable'], answer: '13', rewardItem: 'sheet-music',
    hints: ['시간표와 같은 좌표의 사물함을 찾자.', '왼쪽에서 3번째, 위에서 3번째 칸 → 13번 사물함.'] },
  { id: 'class-organ', room: 'class', requires: ['class-locker'], answer: 'C-E-G-E-C', rewardItem: 'chalk', consumes: ['sheet-music'],
    hints: ['악보를 풍금 앞에서 펼쳐보자.', '도-미-솔-미-도 순서로 건반을 눌러.'] },
  { id: 'class-board', room: 'class', requires: ['class-organ'], requiresItem: 'chalk', consumes: ['chalk'],
    hints: ['칠판에 희미하게 뭔가 적혀 있던 자국이.', '분필로 칠판을 문질러봐. (화분 아래도 확인!)'] },
  { id: 'class-final', room: 'class', requires: ['class-board'], answer: '2002', consumes: ['diary'],
  ...
  { id: 'store-arcade', room: 'store', requires: ['store-snacks'], requiresItem: 'coin-100', consumes: ['coin-100'],
  ...
  { id: 'store-final', room: 'store', requires: ['store-paperdoll'], requiresItem: 'coin-gacha', consumes: ['coin-gacha'],
